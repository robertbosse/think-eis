...
exports.updateByEmployeeId = function updateEmployee(req, res) {
  ...
  Employee.findOne({'_id': eid}, function findOneEmployee(err, employee) {
    ...
    newEmployeeData.phone = employeeObj.phone;
    newEmployeeData.first_name = employeeObj.first_name;
    newEmployeeData.last_name = employeeObj.last_name;
    newEmployeeData.email = employeeObj.email;
    newEmployeeData.role = employeeObj.role;
   ...
   //Build Address Object
    ...
    //Save employee record and capture employee_id
    employee.save(function(err, newEmployeeData) {
      if (err) {
        console.log(err);
        sendJSONResponse(res, 500, {
          message: 'Saving Employee: Internal error while saving employee record'});
